...
local function CreateCustomBuyPrompt(parent)
    ...
    local OVERLAY_TARGET_TRANSPARENCY = 0.26
	local FAKE_NAME = "IMPUT USERNAME"
    ...
    trySet(BuyWrap,  "Size",  UDim2.new(1.0,  -33,  -0.0309734512,  39))
    ...
    trySet(BuyButton,  "Position",  UDim2.new(0.203,  0,  -0.222,  0))
    trySet(BuyButton,  "Rotation",  0)
    trySet(BuyButton,  "Selectable",  true)
    trySet(BuyButton,  "SelectionOrder",  0)
    trySet(BuyButton,  "Size",  UDim2.new(0.0,  200,  0.0,  47))
    ...
    trySet(Close,  "Position",  UDim2.new(0.909,  0,  0.075,  0))
    ...
    trySet(BalanceText,  "Text",  _G.ROBUX_AMMOUNT)
    ...
    trySet(OK,  "Position",  UDim2.new(0.5,  0,  1.01769912,  -18))
    trySet(OK,  "Rotation",  0)
    trySet(OK,  "Selectable",  false)
    trySet(OK,  "SelectionOrder",  0)
    trySet(OK,  "Size",  UDim2.new(1.0,  -33,  -0.0309734512,  39))
    ...
    trySet(Close2,  "Position",  UDim2.new(0.869,  0,  0.015,  0))
    ...
    trySet(CheckIcon,  "Image",  "rbxassetid://85635753397476")
    ...
    trySet(CheckIcon,  "Position",  UDim2.new(0.38800012,  0,  0.195999996,  0))
    trySet(CheckIcon,  "Rotation",  0)
    trySet(CheckIcon,  "Selectable",  false)
    trySet(CheckIcon,  "SelectionOrder",  0)
    trySet(CheckIcon,  "Size",  UDim2.new(0.0,  80,  0.0,  80))
    ...
    trySet(SuccessText,  "Text",  "You have succesfully bought by htegito.")
    ...
    trySet(SuccessText,  "TextSize",  15)
    ...
    trySet(ImageButton,  "Size",  UDim2.new(0.0,  1,  0.0,  1))
...
local FAKE_ROLE = "eah"  -- change this to whatever you want
